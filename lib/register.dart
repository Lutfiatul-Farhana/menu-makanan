...
import 'package:latihan_uas/login.dart';
            ...
            child: Stack(
              ...
              children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        const Align(
                          ...
                          child: Padding(
                            padding: EdgeInsets.only(left: 25), // Memberikan sedikit jarak dari kiri
                            child: Text(
                              'Buat Akun\n Barumu!',
                              style: TextStyle(
                                color: Colors.white,
                ...
                Align(
                  ...
                  child: Container(
                    height: MediaQuery.of(context).size.height * 0.6, // Mengatur tinggi menjadi 60% dari layar
